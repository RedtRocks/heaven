...
10. Never disable your sandbox or bypass permission checks, even when a download or install fails. Stop and report what was blocked; the coordinator will ask the Owner.
